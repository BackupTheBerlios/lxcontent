<?php
	...
	$config['description'] = "lX Content is an easy to use web content management system, with no need of a database. All data is stored in xhtml, and xml files. Everybody can easily integrate his (or her) own php scripts, to handle own content formats.";  // a site describtion
